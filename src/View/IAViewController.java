...
public class IAViewController extends ToolsBarController implements Initializable
{
	...
	public IAViewController(String ia)
	{
	...
	public void turnIA(double[] plateau)
	{
		double[] probOUT = new double[9] ;
		probOUT = IA.getNet().forwardPropagation(plateau) ;
	...
	void onClickButton00()
	{
		...
		this.turnIA(this.game.getChoicePlayeurStrings());
	}
